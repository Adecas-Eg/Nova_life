<div class="multisteps-form">
    ...
    <div class="row">
        <div class="col col-lg-8 m-auto col-sm-12">
            <form class="multisteps-form__form mb-8" style="height: 406px;" id="miFormulario"
                ...
                <input type="text" name="geometry" style="display: none" value="{{old('geometry')}}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input class="multisteps-form__input form-control" type="text"
                                        placeholder="Bolivar" name="departamento"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-  col-sm-4">
                                ...
                                <input class=" multisteps-form__input form-control" type="number" name="antiguedad"
                                    value="{{ old('antiguedad', isset($casa) ? $casa->antiguedad : null) }}" placeholder="años"
                               ...
                               <div class="col-md-6  col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control align-content-between multisteps-form__input"
                                        ...
                                        value="{{ old('url_3d', isset($casa) ? $casa->url_3d : null) }}" placeholder="">
